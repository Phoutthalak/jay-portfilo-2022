    ...
    return (
        <div className="group relative flex cursor-pointer">
            <motion.img
                ...
                alt=""
                className="rounded-full border border-gray-500 object-fill w-16 h-16 md:w-16 md:h-16 xl:w-16 xl:h-16 filter group-hover:grayscale transition duration-300 ease-in-out"
            />
